...
export const movies: Movie[] = [
...

  {
    id: 'scary-movie-5',
    title: 'Scary Movie 5',
    description: 'Une parodie des films d\'horreur et des blockbusters, où Jody et Dan découvrent que leur maison est hantée.',
    thumbnail: '/images/movies/scary-movie-5.jpg',
    year: 2013,
    duration: '1h 26min',
    ...
    sources: [
      {
        name: 'VF',
        url: 'https://uqload.cx/embed-36q8gj6aygiz.html',
        language: 'VF'
      }
    ]
  },
...

  {
    ...
    description: 'Frieren, une mage elfe immortelle, entreprend un voyage introspectif pour comprendre la vie humaine et ses émotions. Après avoir vaincu le Roi Démon avec son groupe d\'aventuriers, elle revisite des lieux et des souvenirs tout en formant de nouvelles relations.',
    thumbnail: '/images/movies/frieren.jpg',
    year: 2023,
    duration: '24min',
    genre: ['Anime', 'Aventure', 'Fantasy', 'Drame'],
    rating: 9.4,
    category: 'Movies',
    isNew: true,
    isPopular: true,
    ...
    sources: [
      {
        name: 'Épisode 2',
        url: 'https://vidmoly.net/embed-ll59v3s11y1o.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 3',
        url: 'https://vidmoly.net/embed-zh548jkvzqow.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 4',
        url: 'https://vidmoly.net/embed-dnlqthrkqohz.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 5',
        url: 'https://vidmoly.net/embed-6j824otfeh7l.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 6',
        url: 'https://vidmoly.net/embed-soyancr9z7qw.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 7',
        url: 'https://vidmoly.net/embed-bb882t83omfq.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 8',
        url: 'https://vidmoly.net/embed-ww41bu0hbeln.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 9',
        url: 'https://vidmoly.net/embed-rbnikah15kjy.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 10',
        url: 'https://vidmoly.net/embed-1nmenewr3e7m.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 11',
        url: 'https://vidmoly.net/embed-4q904zqr7jf7.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 12',
        url: 'https://vidmoly.net/embed-vrxh1y61nnzs.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 13',
        url: 'https://vidmoly.net/embed-jlnvm5mbwnl3.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 14',
        url: 'https://vidmoly.net/embed-d32pzjfbfxkj.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 15',
        url: 'https://vidmoly.net/embed-08doyh2zdqt1.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 16',
        url: 'https://vidmoly.net/embed-47hraihukjjj.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 17',
        url: 'https://vidmoly.net/embed-sgs20plyexrz.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 18',
        url: 'https://vidmoly.net/embed-uy5hkagwn8e9.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 20',
        url: 'https://vidmoly.net/embed-qyq6s3gd5u8w.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 21',
        url: 'https://vidmoly.net/embed-lfd35sxd84gk.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 23',
        url: 'https://vidmoly.net/embed-c2o1cnwhym5z.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 24',
        url: 'https://vidmoly.net/embed-50osbqb6zai9.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 25',
        url: 'https://vidmoly.net/embed-rrstikhxhtjp.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 26',
        url: 'https://vidmoly.net/embed-mz7jbzknqmlx.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 27',
        url: 'https://vidmoly.net/embed-9vga0hjnw927.html',
        language: 'VOSTFR'
      },
      {
        name: 'Épisode 28',
        url: 'https://vidmoly.net/embed-fbk19e712gws.html',
        language: 'VOSTFR'
      }
    ]
  },
