      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-background border-b border-border">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between gap-2 sm:gap-6 h-14 sm:h-20">
            ...
            <Link 
              href="/favorites" 
              className="relative flex-shrink-0 hidden md:flex items-center justify-center h-12 w-12 rounded-lg border-2 border-[#3498DB] text-[#3498DB] hover:bg-[#3498DB] hover:text-white transition-all group"
            >
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <div className="hidden lg:flex items-center gap-3">
                {user ? (
                  ...
                  <Button 
                    variant="outline" 
                    className="border-[#3498DB] text-[#3498DB] hover:bg-[#3498DB] hover:text-white font-label font-semibold rounded-lg h-11 px-4" 
                    asChild
                  >
