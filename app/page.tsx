...
export default async function Home() {
  ...
  return (
    <MainLayout>
      ...
      <section className="w-full sm:container sm:max-w-7xl sm:mx-auto px-0 sm:px-4 md:px-6 -mt-[88px] sm:mt-0 pt-0 sm:pt-6 md:pt-8 pb-4 sm:pb-6" data-hero-section>
